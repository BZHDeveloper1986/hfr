// ==UserScript==
// @name          [HFR] Vos smileys favoris mod_pj
// @version       3.0.9
...
// @updateURL     https://gitlab.com/BZHDeveloper/hfr/-/raw/master/hfr_vos_smileys_mod_pj.user.js
// @installURL    https://gitlab.com/BZHDeveloper/hfr/-/raw/master/hfr_vos_smileys_mod_pj.user.js
// @downloadURL   https://gitlab.com/BZHDeveloper/hfr/-/raw/master/hfr_vos_smileys_mod_pj.user.js
...
if(typeof GM_registerMenuCommand === "undefined") {
	GM_registerMenuCommand = (caption, commandFunc, accessKey) => {
		var menu = document.querySelector ("menu#hfr-gm4-menu");
		if (menu == null) {
			menu = document.createElement ("menu");
			document.body.appendChild (menu);
			menu.setAttribute ("id", "hfr-gm4-menu");
			menu.setAttribute ("type", "context");
		}
		var submenu = menu.querySelector ("menu.hfr");
		if (submenu == null) {
			submenu = document.createElement ("menu");
			submenu.setAttribute ("label", GM.info.script.name);
			submenu.setAttribute ("class", "hfr");
		}
		var item = document.createElement ("menuitem");
		item.setAttribute ("label", caption);
		item.setAttribute ("icon", "https://gitlab.com/BZHDeveloper/HFR/raw/master/hfr-logo.png");
		item.addEventListener ("click", commandFunc, false);
		submenu.appendChild (item);
		menu.appendChild (submenu);
		document.body.addEventListener ("contextmenu", evt => { document.body.setAttribute("contextmenu", "hfr-gm4-menu"); }, false);
	};
}
